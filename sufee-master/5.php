...
?>
  ...
  <th scope="col"><label for="action">ACTION</label></th>
        ...
        while($rowlist = $reslist->fetch_assoc()) {        
            ...
            echo "<td ><a href=\"editTraining.php?Training_Id=$rowlist[Training_Id]\">Edit</a> | <a href=\"deleteTraining.php?Training_Id=$rowlist[Training_Id]\" onClick=\"return confirm('Are you sure you want to delete?')\">Delete</a></td>";      
        }
        ?>
