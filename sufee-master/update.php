                                ...
                                <table class="table" width="25%" border="0">
                                    <tbody>
										...
										<tr >
                                             ...
                                             <th scope="col" ><textarea class="form-control" name="jobRequire" rows="10" cols="50"placeholder="Enter Job Requirement" value=""></textarea>
                          </th>
                                        </tr>
										
										<tr >
                                             <th scope="col"><label for="jobSalary">Salary</label></th>
                                             <th scope="col" ><input class="form-control" name="jobSalary" type="text"  placeholder="Enter job salary" value="">
                          </th>
