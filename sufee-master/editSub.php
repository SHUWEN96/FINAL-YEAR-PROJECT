...
if(isset($_POST['update'])) {    
    ...
    if(empty($subject) || empty($gred) ) {                
       ...
       $result = mysqli_query($mysqli, "UPDATE subject SET subject='$subject',gred='$gred' WHERE subject_id=$subject_id");
        ...
        echo "<br/><a href='subject.php'>View Result</a>";
    }
}		
?>
...
<body>
    <br/><br/>
    <form class="form-inline" method="post" action="editSub.php?subject_id=<?php echo $subject_id?>" enctype="multipart/form-data">
		     ...
		     <div class="animated">
	                ...
	                <div class="modal-dialog modal-lg" role="document">
	                     <div class="modal-content">
							...
							<div class="modal-body">
                                ...
                                <table class="table" width="25%" border="0">
									...
									<th scope="col">Education Level</th>
											 ...
											 placeholder="<?php echo $_SESSION['SESS_EDU_TYPE'] ?>" readonly></th>
							...
							<input style="border-radius: 8px;" type="submit" name="update" value="Update" class="btn btn-success" /><a class="btn btn-primary" href="subject.php">Back</a>
