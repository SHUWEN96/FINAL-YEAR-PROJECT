									 ...
									 while($rowlist = $reslist->fetch_assoc()) { 
											...
											if ($rowlist['Status_1'] == 'interview') {
											   echo "<tr>";
													...
													echo"<td style='width:35%'>" .$rowlist['Applicant_Name']." </td>";
													echo"<td style='width:30%'>" .$rowlist['user_Ic']."</td>";
													echo"<td style='width:30%'>" .$rowlist['Status_1']."</td>";
													echo"<td style='width:15%'><a style='border-radius: 8px;' class='btn btn-primary' href ='notify.php?Applicant_Name=$rowlist[Applicant_Name] & user_Ic=$rowlist[user_Ic] '>Notify</a></td>";
