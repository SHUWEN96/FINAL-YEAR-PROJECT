...
<tr style="height: 20px;"> 
  ...
  <th scope="col"><label for="Work_End_Date">Date End</label></th> 
        ...
        while($rowlist = $reslist->fetch_assoc()) {        
            ...
            echo "<td style='width:20%'><a href=\"editExperience.php?Work_Experience_Id=$rowlist[Work_Experience_Id]\">Edit</a> | <a href=\"deleteExperience.php?Work_Experience_Id=$rowlist[Work_Experience_Id]\" onClick=\"return confirm('Are you sure you want to delete?')\">Delete</a></td>";        
        }
        ?>
                                    </tbody>
                                </table>
