...
?>
 ...
 echo "<td style='width:20%'><a href=\"editSub.php?subject_id=$rowlist[subject_id]\">Edit</a> | <a href=\"deleteSub.php?subject_id=$rowlist[subject_id]\" onClick=\"return confirm('Are you sure you want to delete?')\">Delete</a></td>"; 													 
		    echo "</tr>";}
				...
				<div class="modal fade" id="smallModal" tabindex="-1" role="dialog" aria-labelledby="smallmodalLabel" aria-hidden="true">
                    <div class="modal-dialog modal-lg" role="document">
                        <div class="modal-content">
                               ...
                               <div class="card-body">
                                <table class="table" width="25%" border="0">
									...
									<th scope="col">Education Level</th>
											 ...
											 placeholder="<?php echo $_GET['Edu_Type'] ?>" readonly></th>
							...
							<a style="border-radius: 8px;" class="btn btn-primary" href="subject.php">Back</a>
