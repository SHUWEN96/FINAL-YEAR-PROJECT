							...
							<div class="modal-body">
                                ...
                                <table class="table" width="25%" border="0">
                                    <tbody>
									   ...
									   <tr>
                                            <th scope="col">Subject : Invitation to Interview </th>
					...
					$reslist = $db->query($qlist);
									...
									$reslist = $db->query($qlist);
									 ...
									 while($rowlist = $reslist->fetch_assoc()) { 
											   ...
											   $user_Ic=$rowlist["user_Ic"];
									echo "<tr>";     
									echo "<td style='width:50%' >"."<strong>". "Dear : "."</strong>" . $rowlist["Applicant_Name"]. "<br>"."</td>";
									echo "</tr>"; 
									echo "<tr>";     									
									echo "<td style='width:50%'>"."<strong>". "Message  : "."</strong>" . $rowlist["message"]. "<br>"."</td>";
									echo "</tr>";
