...
$app_post2 = $_POST['app_post2'];
    ...
    if(empty($faculty) || empty($app_post1) || empty($app_post2) ) {                
        if(empty($faculty)) {
		...
		if(empty($app_post2)) {
            echo "<script>alert('Applicant position 2 field is empty.')</script>";
       ...
       $result = mysqli_query($mysqli, "UPDATE position SET faculty='$faculty',app_post1='$app_post1',app_post2='$app_post2' WHERE Choose_Position_Id=$Choose_Position_Id");
								...
								<input type="hidden" class="form-control" name="user_Ic" id="disabledInput" type="text" placeholder="<?php echo $_SESSION['SESS_NOIC'] ?>" readonly>
                                    <tbody>
										...
										<tr>
                                            ...
                                            <th scope="col"><select id="app_post2" class="form-control" value="<?php echo $app_post2;?>" name="app_post2">
                                                 <option value=""></option>
												 <option value="DS45 LECTURER">DS45 LECTURER</option>
                                                 <option value="DS51 LECTURER">DS51 LECTURER</option>
                                                 <option value="DS53 PROFESOR MADYA">DS53 PROFESOR MADYA</option>
